...
***Note: it is highly recommended that, rather than going through all the steps here to configure Argo CD, that for convenience and faster you instead use the [essesseff-onboarding-utility](https://github.com/essesseff/essesseff-onboarding-utility)***
